...
*/
    ...
    var translations = {
      en: {
        ...
        'hero1.cta': 'Product introduction',
        ...
        'about.body1': 'Asaki CASACHY, founded in 2013, seeks to revive the Song-era aesthetic and cultivate a refined, modern literati lifestyle. We distill Eastern design elements and craftsmanship, using traditional techniques to create furniture and objects that restore the ideal literati living space.',
      ...
      ja: {
        ...
        'about.body1': '浅喜CASACHY は2013年創業。宋代の生活美学を現代に蘇らせ、新しい文人の雅な暮らしを提案します。東洋の美意識を磨き、職人の技を込め、伝統技法で家具や器物を丹念に仕上げ、理想の文人空間を形にします。',
      ...
      zh: {
        ...
        'about.body1': '浅喜CASACHY，创立于2013年，本着复兴宋代生活美学的愿望，致力于修习新文人雅致生活。提炼东方美学元素，凝聚匠人匠心，以传统工艺手法精心制作家具、器物，还原文人理想生活空间。',
